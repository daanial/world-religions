 ...
 * placeholder, so /fa/religion/slavic-baltic renders correctly (in English)
 ...
 *
 * English source: ../slavic-baltic.ts
 */
import type { ReligionArticle } from "../types";
import { slavicBalticArticle } from "../slavic-baltic";

export const slavicBalticArticleFa: ReligionArticle = slavicBalticArticle;
