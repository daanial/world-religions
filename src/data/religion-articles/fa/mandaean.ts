 ...
 * placeholder, so /fa/religion/mandaean renders correctly (in English)
 ...
 *
 * English source: ../mandaean.ts
 */
import type { ReligionArticle } from "../types";
import { mandaeanArticle } from "../mandaean";

export const mandaeanArticleFa: ReligionArticle = mandaeanArticle;
