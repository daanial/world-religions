 ...
 * placeholder, so /fa/religion/mithraism renders correctly (in English)
 ...
 *
 * English source: ../mithraism.ts
 */
import type { ReligionArticle } from "../types";
import { mithraismArticle } from "../mithraism";

export const mithraismArticleFa: ReligionArticle = mithraismArticle;
