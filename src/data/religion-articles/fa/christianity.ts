 ...
 * placeholder, so /fa/religion/christianity renders correctly (in English)
 ...
 *
 * English source: ../christianity.ts
 */
import type { ReligionArticle } from "../types";
import { christianityArticle } from "../christianity";

export const christianityArticleFa: ReligionArticle = christianityArticle;
