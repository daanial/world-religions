 ...
 * placeholder, so /fa/religion/hinduism renders correctly (in English)
 ...
 *
 * English source: ../hinduism.ts
 */
import type { ReligionArticle } from "../types";
import { hinduismArticle } from "../hinduism";

export const hinduismArticleFa: ReligionArticle = hinduismArticle;
