 ...
 * placeholder, so /fa/religion/greek-roman renders correctly (in English)
 ...
 *
 * English source: ../greek-roman.ts
 */
import type { ReligionArticle } from "../types";
import { greekRomanArticle } from "../greek-roman";

export const greekRomanArticleFa: ReligionArticle = greekRomanArticle;
