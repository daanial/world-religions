 ...
 * placeholder, so /fa/religion/santeria renders correctly (in English)
 ...
 *
 * English source: ../santeria.ts
 */
import type { ReligionArticle } from "../types";
import { santeriaArticle } from "../santeria";

export const santeriaArticleFa: ReligionArticle = santeriaArticle;
