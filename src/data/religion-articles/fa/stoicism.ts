 ...
 * placeholder, so /fa/religion/stoicism renders correctly (in English)
 ...
 *
 * English source: ../stoicism.ts
 */
import type { ReligionArticle } from "../types";
import { stoicismArticle } from "../stoicism";

export const stoicismArticleFa: ReligionArticle = stoicismArticle;
