 ...
 * placeholder, so /fa/religion/dreamtime renders correctly (in English)
 ...
 *
 * English source: ../dreamtime.ts
 */
import type { ReligionArticle } from "../types";
import { dreamtimeArticle } from "../dreamtime";

export const dreamtimeArticleFa: ReligionArticle = dreamtimeArticle;
