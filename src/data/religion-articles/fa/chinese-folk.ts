 ...
 * placeholder, so /fa/religion/chinese-folk renders correctly (in English)
 ...
 *
 * English source: ../chinese-folk.ts
 */
import type { ReligionArticle } from "../types";
import { chineseFolkArticle } from "../chinese-folk";

export const chineseFolkArticleFa: ReligionArticle = chineseFolkArticle;
