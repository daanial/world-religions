 ...
 * placeholder, so /fa/religion/candomble renders correctly (in English)
 ...
 *
 * English source: ../candomble.ts
 */
import type { ReligionArticle } from "../types";
import { candombleArticle } from "../candomble";

export const candombleArticleFa: ReligionArticle = candombleArticle;
