 ...
 * placeholder, so /fa/religion/confucianism renders correctly (in English)
 ...
 *
 * English source: ../confucianism.ts
 */
import type { ReligionArticle } from "../types";
import { confucianismArticle } from "../confucianism";

export const confucianismArticleFa: ReligionArticle = confucianismArticle;
