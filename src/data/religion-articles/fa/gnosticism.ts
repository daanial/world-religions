 ...
 * placeholder, so /fa/religion/gnosticism renders correctly (in English)
 ...
 *
 * English source: ../gnosticism.ts
 */
import type { ReligionArticle } from "../types";
import { gnosticismArticle } from "../gnosticism";

export const gnosticismArticleFa: ReligionArticle = gnosticismArticle;
