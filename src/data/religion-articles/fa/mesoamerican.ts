 ...
 * placeholder, so /fa/religion/mesoamerican renders correctly (in English)
 ...
 *
 * English source: ../mesoamerican.ts
 */
import type { ReligionArticle } from "../types";
import { mesoamericanArticle } from "../mesoamerican";

export const mesoamericanArticleFa: ReligionArticle = mesoamericanArticle;
