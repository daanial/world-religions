 ...
 * placeholder, so /fa/religion/sumerian renders correctly (in English)
 ...
 *
 * English source: ../sumerian.ts
 */
import type { ReligionArticle } from "../types";
import { sumerianArticle } from "../sumerian";

export const sumerianArticleFa: ReligionArticle = sumerianArticle;
