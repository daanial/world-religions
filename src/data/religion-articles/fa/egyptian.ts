 ...
 * placeholder, so /fa/religion/egyptian renders correctly (in English)
 ...
 *
 * English source: ../egyptian.ts
 */
import type { ReligionArticle } from "../types";
import { egyptianArticle } from "../egyptian";

export const egyptianArticleFa: ReligionArticle = egyptianArticle;
