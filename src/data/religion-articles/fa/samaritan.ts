 ...
 * placeholder, so /fa/religion/samaritan renders correctly (in English)
 ...
 *
 * English source: ../samaritan.ts
 */
import type { ReligionArticle } from "../types";
import { samaritanArticle } from "../samaritan";

export const samaritanArticleFa: ReligionArticle = samaritanArticle;
