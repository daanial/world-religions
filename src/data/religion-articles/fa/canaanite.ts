 ...
 * placeholder, so /fa/religion/canaanite renders correctly (in English)
 ...
 *
 * English source: ../canaanite.ts
 */
import type { ReligionArticle } from "../types";
import { canaaniteArticle } from "../canaanite";

export const canaaniteArticleFa: ReligionArticle = canaaniteArticle;
