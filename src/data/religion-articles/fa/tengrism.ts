 ...
 * placeholder, so /fa/religion/tengrism renders correctly (in English)
 ...
 *
 * English source: ../tengrism.ts
 */
import type { ReligionArticle } from "../types";
import { tengrismArticle } from "../tengrism";

export const tengrismArticleFa: ReligionArticle = tengrismArticle;
