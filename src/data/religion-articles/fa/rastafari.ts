 ...
 * placeholder, so /fa/religion/rastafari renders correctly (in English)
 ...
 *
 * English source: ../rastafari.ts
 */
import type { ReligionArticle } from "../types";
import { rastafariArticle } from "../rastafari";

export const rastafariArticleFa: ReligionArticle = rastafariArticle;
