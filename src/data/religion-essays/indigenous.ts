...
export const INDIGENOUS_ESSAYS: Record<string, ReligionEssay> = {
  santeria: {
    paragraphs: [
    ...
    sources: [
      {
        label: "Britannica — Santería",
        href: "https://www.britannica.com/topic/Santera",
      },
      {
        label: "Smithsonian — African Diaspora Religions",
        href: "https://www.smithsonianmag.com/history/the-african-diaspora-religions-180976441/",
      },
      {
        label: "UNESCO — Intangible Cultural Heritage",
        href: "https://ich.unesco.org/en/home",
      },
    ],
  },
  ...
  yoruba: {
    ...
    sources: [
      {
        label: "Britannica — Yoruba religion",
        href: "https://www.britannica.com/topic/Yoruba-religion",
      },
      {
        label: "BBC Religion — Yoruba",
        href: "https://www.bbc.co.uk/religion/religions/yoruba/",
      },
      {
        label: "Smithsonian — Yoruba Art and Culture",
        href: "https://africa.si.edu/exhibitions/current-exhibitions/yoruba/",
      },
    ],
  },
  ...
  vodou: {
    ...
    sources: [
      {
        label: "Britannica — Vodou",
        href: "https://www.britannica.com/topic/Vodou",
      },
      {
        label: "Smithsonian — Vodou",
        href: "https://www.smithsonianmag.com/arts-culture/vodou-142965516/",
      },
      {
        label: "BBC Religion — Vodou",
        href: "https://www.bbc.co.uk/religion/religions/vodou/",
      },
    ],
  },
  ...
  inuit: {
    ...
    sources: [
      {
        label: "Britannica — Inuit",
        href: "https://www.britannica.com/topic/Inuit",
      },
      {
        label: "Smithsonian Arctic Studies Center",
        href: "https://www.smithsonianmag.com/smithsonian-institution/the-arctic-studies-center-180949088/",
      },
      {
        label: "Canadian Museum of History — Inuit",
        href: "https://www.historymuseum.ca/cmc/exhibitions/civil/inuit/inuit00e.html",
      },
    ],
  },
  ...
  navajo: {
    ...
    sources: [
      {
        label: "Britannica — Navajo",
        href: "https://www.britannica.com/topic/Navajo-people",
      },
      {
        label: "Smithsonian — Navajo Culture",
        href: "https://www.smithsonianmag.com/smithsonian-institution/navajo-180949088/",
      },
      {
        label: "National Park Service — Diné History",
        href: "https://www.nps.gov/articles/dine-history-and-culture.htm",
      },
    ],
  },
  ...
  maori: {
    ...
    sources: [
      {
        label: "Te Ara — Māori Religion",
        href: "https://teara.govt.nz/en/maori-religion-and-belief",
      },
      {
        label: "Britannica — Māori",
        href: "https://www.britannica.com/topic/Maori",
      },
      {
        label: "UNESCO — Māori Cultural Heritage",
        href: "https://ich.unesco.org/en/state/aotearoa-new-zealand-NZ",
      },
    ],
  },
  ...
  dreamtime: {
    ...
    sources: [
      {
        label: "AIATSIS — Aboriginal Spirituality",
        href: "https://aiatsis.gov.au/explore/articles/aboriginal-spirituality",
      },
      {
        label: "Britannica — Australian Aboriginal peoples",
        href: "https://www.britannica.com/topic/Australian-Aboriginal",
      },
      {
        label: "UNESCO — Australian Indigenous Heritage",
        href: "https://whc.unesco.org/en/statesparties/au",
      },
    ],
  },
  ...
  ifa: {
    ...
    sources: [
      {
        label: "Britannica — Ifa",
        href: "https://www.britannica.com/topic/Ifa",
      },
      {
        label: "UNESCO — Ifa Divination System",
        href: "https://ich.unesco.org/en/RL/ifa-divination-system-00963",
      },
      {
        label: "Smithsonian — Yoruba Divination",
        href: "https://africa.si.edu/exhibitions/current-exhibitions/yoruba/divination/",
      },
    ],
  },
