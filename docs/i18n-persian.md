...
The Persian route is active at `/fa`. Shared navigation, footer, loading and error states are translated, as are Concepts, Traditions, Landing, Compare, About, Inward Paths and Pilgrimage. The Bahá’í Faith, Buddhism, Zoroastrianism, Islam, Judaism and Hinduism have Persian article modules; a fidelity audit found condensed passages in several of them, so they are not final until sentence-level comparison is complete. Islam, Judaism and Hinduism also have localized religion metadata. The remaining 38 religion articles intentionally fall back to English until their translation phase. See [`i18n-audit.md`](./i18n-audit.md) for the audit result and completion rule.
