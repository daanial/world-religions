...
The Persian localization is not complete and must not yet be described as a full translation. The six religion modules without fallback markers are working Persian modules, but several still contain condensed prose rather than a paragraph-by-paragraph translation of the English source. The Imam Reza/Fatima Masumeh passage in Islam was one confirmed example and has been restored in full detail. Judaism was subsequently rewritten with expanded, detail-preserving prose; it has no current checker warning, but still requires sentence-level editorial review before completion.
